<h2>A reserva: <a href="https://salas.fflch.usp.br/reservas/{{ $reserva->id }}">{{$reserva->id}}</a> foi modificada no site <a href="https://salas.fflch.usp.br/" >salas.fflch.usp.br</a></h2>
